...
class InternshipProgram extends StatefulWidget {
  PlaceModel placeModel;
  InternshipProgram({this.placeModel});
  @override
  _InternshipProgramDetail createState() => _InternshipProgramDetail();
}

class _InternshipProgramDetail extends State<InternshipProgram> {
  int numberPackage = 0;
